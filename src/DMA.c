...
void DMA_Config(GPDMA_LLI_T* lli) {
    ...
    configDMA.transferSize =
        4095; // para hacer la maxima cantidad de transferencias y luego reconfigurar
    configDMA.type =
        GPDMA_P2M; // tratamos al DAC como memoria, ya que aguanta la frecuencia de muestreo
